...
const Cart = () => {
    ...
    if(!cart || cart.length === 0) return <h1 className="flex items-center justify-center h-screen bg-gray-100 text-lg font-bold text-gray-900">Cart is Empty!</h1>
  ...
  return (
    <div className="lg:px-14 sm:px-8 px-4 py-10">
      ...
      <div className="grid md:grid-cols-5 grid-cols-4 gap-4 pb-2 font-semibold items-center">
        ...
        <div className="justify-self-center text-lg slate-800">
            Price
        </div>
      ...
      <div>
        ...
        <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4">
                ...
                <div className="flex text-sm gap-1 flex-col">
                    ...
                    <button
                        onClick={() => {}}
                        className="font-semibold w-[300px] py-2 px-4 rounded-sm bg-custom-blue text-white flex items-center justify-center gap-2 hover:gray-300 transition duration-500">

      ...
      <Dialog open={open} as="div" className="relative z-10 " onClose={close} __demoMode>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className="w-full max-w-max rounded-xl bg-white/80 p-6 backdrop-blur-3xl duration-300 ease-out data-closed:transform-[scale(95%)] data-closed:opacity-0"
            >
                {image && (
                  <div className='flex justify-center aspect-3/2 '>
                    <img className="w-full h-full cursor-pointer transition-transform duration-300 transform hover:scale-105 rounded-xl" 

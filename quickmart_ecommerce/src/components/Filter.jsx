...
import { MenuItem, Select,Tooltip, Button } from "@mui/material";
...
const Filter = () => {
    ...
    return (
        <div className="flex lg:flex-row flx-col-reverse lg:justify-between justify-center items-center gap-4">
            {/* SEARCH BAR */}
